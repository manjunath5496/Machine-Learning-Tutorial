...
<pre> In situation s perform action a;
 Receive consequence situation s&rsquo;;
 Compute emotion of being in consequence situation v(s&rsquo;);
 Update crossbar memory  w&rsquo;(a,s) = w(a,s) + v(s&rsquo;).
</pre>
